...
<body>
    ...
    <form action="http://localhost:8080/pagina_php/Formulario_Inicial.html" method="post">
    ...
    <form action="http://localhost:8080/pagina_php/Matriz_de_Riezgo.html" method="post">
